...
public class BinaryHeap<E extends Comparable<E>> {
	...
	// permet de remonter un element situe a l'indice donne jusqu'a ce qu'il
	// soit bien place
	private void percolateUp(int index) {
		E x = this.array.get(index);

		for (; index > 0
				&& x.compareTo(this.array.get(index_parent(index))) < 0; index = index_parent(index)) {
	...
	// mis a jour d'un sommet : il est replace au bon endroit
